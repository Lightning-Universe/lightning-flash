...
from typing import Any, Callable, Dict, get_type_hints, List, Mapping, Optional, Sequence, Union
...
class Preprocess(Properties, torch.nn.Module):
    ...
    def __init__(
        ...
        self._serving_inputs: Optional[Dict[str, BaseType]] = None
        self._serving_outputs: Optional[Dict[str, BaseType]] = None

    @property
    def serving_inputs(self) -> Optional[Dict[str, BaseType]]:
        return self._serving_inputs
