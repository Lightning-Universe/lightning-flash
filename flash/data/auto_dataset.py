...
from flash.data.utils import _STAGES_PREFIX, _STAGES_PREFIX_VALUES, set_current_stage_and_fn
...
class AutoDataset(Dataset):
    ...
    def _call_load_data(self, data: Any) -> Iterable:
        ...
        with set_current_stage_and_fn(self._preprocess, self._running_stage, "load_data"):
    ...
    def __getitem__(self, index: int) -> Any:
        ...
        with set_current_stage_and_fn(self._preprocess, self._running_stage, "load_sample"):
            if self.load_sample:
