...
class Task(pl.LightningModule):
    ...
    def _set_pipeline(self, data_pipeline):
        preprocess = data_pipeline._preprocess_pipeline
        postprocess = data_pipeline._postprocess_pipeline
        postprocess = self.postprocess if postprocess is None else postprocess
        self._data_pipeline = DataPipeline(preprocess, postprocess)
