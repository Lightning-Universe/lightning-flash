...
from typing import Any, Callable, Generic, Iterable, Mapping, Optional, Type, TypeVar, Union
...
class FlashDataset(Dataset, BaseDataset[DATA_TYPE]):
    ...
    def load_data(self, data: DATA_TYPE) -> Mapping:
...
class FlashIterableDataset(IterableDataset, BaseDataset[DATA_TYPE]):
    ...
    def load_data(self, data: DATA_TYPE) -> Iterable:
        """By default, the `load_data` perform an identity operation.
