...
from flash.core.data.io.input import BaseInput, InputDataKeys, has_len
...
class LabelStudioInput(BaseInput):
    """The ``LabelStudioInput`` expects the input to
    :meth:`~flash.core.data.io.input.BaseInput.load_data` to be a json export from label studio."""
