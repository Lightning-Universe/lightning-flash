...
class FlashBaseFinetuning(BaseFinetuning):
    ...
    def __init__(self, attr_names: Union[str, List[str]] = "backbone", train_bn: bool = True):
        ...
        Override ``finetuning_function`` to put your unfreeze logic.
    ...
    def finetuning_function(self, pl_module: pl.LightningModule, epoch: int, optimizer: Optimizer, opt_idx: int):
        pass
