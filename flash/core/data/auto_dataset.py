...
class BaseAutoDataset(Generic[DATA_TYPE]):
    """The ``BaseAutoDataset`` class wraps the output of a call to :meth:`~flash.core.data.io.input.BaseInput.load_data`
    and a :class:`~fash.data.io.input.BaseInput` and provides the ``_call_load_sample`` method to call
    :meth:`~flash.core.data.io.input.BaseInput.load_sample` with the correct
    ...
    Args:
        data: The output of a call to :meth:`~flash.core.data.io.input.BaseInput.load_data`.
        data_source: The :class:`~flash.core.data.io.input.BaseInput` which has the ``load_sample`` method.
    ...
    def __init__(
        self,
        data: DATA_TYPE,
        data_source: "flash.core.data.io.input.BaseInput",
    ...
    def running_stage(self, running_stage: RunningStage) -> None:
        ...
        from flash.core.data.io.input import BaseInput  # noqa F811 # TODO: something better than this
