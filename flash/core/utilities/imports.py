...
_IMAGE_AVAILABLE = (
    _TORCHVISION_AVAILABLE and _TIMM_AVAILABLE and _PIL_AVAILABLE and _KORNIA_AVAILABLE and _MATPLOTLIB_AVAILABLE
    and _COCO_AVAILABLE and _FIFTYONE_AVAILABLE
)
