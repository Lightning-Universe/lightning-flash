...
class TextGenerationPreprocess(Preprocess):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            data_sources={
                DefaultDataSources.CSV: TextGenerationCSVDataSource(self.backbone, max_length=max_length),
                DefaultDataSources.JSON: TextGenerationJSONDataSource(self.backbone, max_length=max_length),
                "sentences": TextGenerationSentencesDataSource(self.backbone, max_length=max_length),
            },
            default_data_source="sentences",
            deserializer=TextGenerationDeserializer(backbone, max_length),
        )
...
class TextGenerationPostprocess(Postprocess):
    def per_batch_transform(self, batch: Any) -> Any:
...
class TextGenerationData(DataModule):
    """Data Module for text classification tasks."""

    preprocess_cls = TextGenerationPreprocess
    postprocess_cls = TextGenerationPostprocess
