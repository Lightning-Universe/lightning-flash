...
datamodule = VideoClassificationData.from_folders(
    train_folder=os.path.join(os.path.dirname(__file__), "data/kinetics/train"),
    val_folder=os.path.join(os.path.dirname(__file__), "data/kinetics/val"),
...
# 4. Make a prediction
predictions = model.predict(os.path.join(os.path.dirname(__file__), "data/kinetics/predict"))
print(predictions)
