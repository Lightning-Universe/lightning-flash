...
datamodule = VideoClassificationData.from_folders(
    train_folder=os.path.abspath("data/kinetics/train"),
    val_folder=os.path.abspath("data/kinetics/val"),
...
# 4. Make a prediction
predictions = model.predict(os.path.abspath("data/kinetics/predict"))
print(predictions)
