...
You can easily customize `Preprocessing <https://github.com/PyTorchLightning/lightning-flash/blob/master/flash/core/data/process.py>`_ method in the `data_module`.
