...
Let's look at the task of classifying graphs from the IMDB-BINARY data set from `TU Dortmund University <https://chrsmrrs.github.io/datasets>`_.
...
We then create our :class:`~flash.graph.classification.model.GraphClassifier` and train on the IMDB-BINARY data.
