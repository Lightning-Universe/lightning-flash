...
.. list-table:: Terminology
   ...
   * - :class:`~flash.core.data.data_pipeline.DataPipeline`
     - The :class:`~flash.core.data.data_pipeline.DataPipeline` is Flash internal object to manage :class:`~flash.core.data.Deserializer`, :class:`~flash.core.data.data_source.DataSource`, :class:`~flash.core.data.process.Preprocess`, :class:`~flash.core.data.process.Postprocess`, and :class:`~flash.core.data.process.Output` objects.
   ...
   * - :class:`~flash.core.data.process.Output`
     - The :class:`~flash.core.data.process.Output` provides a single :meth:`~flash.core.data.process.Output.serialize` method that is used to convert model outputs (after the :class:`~flash.core.data.process.Postprocess`) to the desired output format during prediction.
...
The :class:`~flash.core.data.process.Output` class provides the logic for converting :class:`~flash.core.data.process.Postprocess` outputs to the desired predict format (e.g. classes, labels, probabilities, etc.).
...
:class:`~flash.core.data.process.Output` behind the scenes.
...
Finally, the :meth:`~flash.core.data.process.Output.serialize` method will be called to serialize the predictions.
