...
.. note:: This tutorial is only intended to help you create a small custom task for a personal project. If you want a more detailed guide, have a look at our `guide on contributing a task to flash. <contributing>`
