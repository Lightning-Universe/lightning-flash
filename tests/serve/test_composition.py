...
from flash.core.utilities.imports import _FASTAPI_AVAILABLE, _SERVE_AVAILABLE, _TORCHVISION_AVAILABLE

if _FASTAPI_AVAILABLE:
    from fastapi.testclient import TestClient


@pytest.mark.skipif(not (_SERVE_AVAILABLE or _TORCHVISION_AVAILABLE), reason="serve libraries aren't installed.")
